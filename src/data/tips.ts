...
export const tips: Tip[] = [
  {
    ...
    detailedInfo: [
      "BÄTTRE MÅENDE",
      "Du mår bättre eftersom frukt och grönt innehåller näringsämnen som ger dig mer energi, förbättrar matsmältningen och stärker kroppens försvar.",
  ...
  },
  {
    ...
    detailedInfo: [
      "BÄTTRE MÅENDE",
      "Fullkorns unika kombination av kostfiber ger långsammare energiåtergivning och bättre mättnad, medan B-vitaminer och järn bidrar till uthållig energi och bra blodbildning.",
      "Magnesium och zink stöttar muskler och immunförsvar, och E-vitamin med antioxidanter skyddar dina celler och hjärta.",
      "Genom att behålla alla delar av kärnan – grodd, kli och mjölkkropp – får du en fullständig näringskombination som samverkar för din långsiktiga hälsa.",
      "",
      "SKYDD MOT SJUKDOM", 
  ...
  },
  {
    ...
    freq: `Veckovis`,
    summary: `Att äta fisk och skaldjur 2 - 3 gånger i veckan hjälper dig att få i dig många lite ovanligare näringsämnen som man behöver för att må bra. Att äta fisk och skaldjur minskar ochså risken för flera sjukdomar.`, 
    detailedInfo: [
      ...
      "",
      "Feta fiskar, som lax, sill och makrill, är rika på omega-3-fetter. De minskar risken för hjärt- och kärlsjukdom eftersom de minskar inflammationer i blodkärlen, sänker blodfetter, och gör blodet tunnare vilket förhindrar farliga blodproppar.",
      "Dessutom stabiliseras hjärtats elektriska system vilket förhindrar hjärtrytmsrubbningar.",
      "",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "",
      "Mättade fetter från t.ex. smör, rött kött, palmolja har motsatt effekt, de höjer LDL-kolesterol och ökar inflammation.",
      "Genom bytesprincipen får du alltså en trippelverkan: lägre dåligt kolesterol, mindre inflammation och tunnare blod.",
      "",
      "Exempel på byte:",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "",
      "Magra mejeriprodukter innehåller kalcium, protein, jod, D-vitaminer m.fl. Det är bra för skelettet...",
      "",
      "Feta mejerier innehåller dock mättat fett. Ett glas standardmjölk innehåller lika mycket mättat fett som sju glas lättmjölk eller 30 glas minimjölk.",
      "",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "",
      "Och framförallt begränsa bearbetade köttprodukter.",
  ...
  },
  {
    ...
    summary: ``, 
    detailedInfo: [
      "Att äta mindre än 6 gram salt per dag minskar risken för högt blodtryck.",
      "",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "Det är en viktig del av en hälsosam livsstil. Rör på dig minst 30 minuter om dagen med måttlig intensitet.",
      "",
      "Exempel:",
  ...
  },
  {
    ...
    summary: ``, 
    detailedInfo: [
      "Att äta baljväxter regelbundet",
      "",
      "Bönor, linser och ärtor är bra proteinkällor och innehåller fibrer.",
      "Baljväxter som bönor, linser, ärtor och kikärtor innehåller protein, fibrer, vitaminer och mineraler.",
