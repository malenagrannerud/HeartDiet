                  ...
                  {tips.map((tip) => (
                    ...
                    >
                      <Label 
                        ...
                        style={{ 
                          color: getContrastColor(tip.color) || '#000000'
                        }}
                      >
                        {tip.title}
                      </Label>
                      <input
                        ...
                        className="h-5 w-5 rounded border-2 border-white focus:ring-2 focus:ring-white focus:ring-offset-2"
                        style={{ 
                          backgroundColor: selectedTipIds.includes(tip.id) ? getContrastColor(tip.color) : 'transparent',
                          borderColor: getContrastColor(tip.color) || '#ffffff'
                        }}
                      />
                    </div>
                  ))}
