    ...
    <div className={pageContainer}>
      ...
      <main className={pagePadding}>
        <div className={standardSpacing.pageContent}>
          ...
          {/* MÅL SECTION - Fixed with icon */}
          <section className={standardSpacing.sectionContent}>
            <Card className={standardCard}>
              <div className="flex items-start gap-5">
                <div className="bg-green-100 p-4 rounded-full flex-shrink-0">
                  {/* Add an icon here - maybe a Target icon or use Home */}
          ...
          {/* TIPS-SIDAN SECTION - Fixed with icon and structure */}
          <section className={standardSpacing.sectionContent}>
            <Card className={standardCard}>
              <div className="flex items-start gap-5">
          ...
          {/* HJÄLP SECTION - Added icon and card */}
          <section className={standardSpacing.sectionContent}>
            <Card className={standardCard}>
              <div className="flex items-start gap-5">
          ...
          <section className={standardSpacing.sectionContent}>
            <div className="bg-green-50 p-8 rounded-lg border-2 border-green-200 flex items-start gap-3">
              <img 
                src={iconImage} 
                alt="Tips icon" 
